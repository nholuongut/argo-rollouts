PACKAGE=github.com/nholuongut/argo-rollouts
...
k8s-proto: go-mod-vendor $(TYPES) ## generate kubernetes protobuf files
	PATH=${DIST_DIR}:$$PATH GOPATH=${GOPATH} go-to-protobuf \
		...
		--packages=github.com/nholuongut/argo-rollouts/pkg/apis/rollouts/v1alpha1 \
	...
	cp -R ${GOPATH}/src/github.com/nholuongut/argo-rollouts/pkg . | true
...
gen-openapi: $(DIST_DIR)/openapi-gen ## generate openapi files
	PATH=${DIST_DIR}:$$PATH GOPATH=${GOPATH} openapi-gen \
		...
		--input-dirs github.com/nholuongut/argo-rollouts/pkg/apis/rollouts/v1alpha1 \
		--output-package github.com/nholuongut/argo-rollouts/pkg/apis/rollouts/v1alpha1 \
