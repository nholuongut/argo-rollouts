...
import (
	...
	"github.com/nholuongut/argo-rollouts/metricproviders"
	...
	"github.com/nholuongut/argo-rollouts/controller"
	"github.com/nholuongut/argo-rollouts/controller/metrics"
	jobprovider "github.com/nholuongut/argo-rollouts/metricproviders/job"
	clientset "github.com/nholuongut/argo-rollouts/pkg/client/clientset/versioned"
	"github.com/nholuongut/argo-rollouts/pkg/signals"
	...
	"github.com/nholuongut/argo-rollouts/utils/tolerantinformer"
	"github.com/nholuongut/argo-rollouts/utils/version"
)
...
func newCommand() *cobra.Command {
	...
	command.Flags().DurationVar(&electOpts.LeaderElectionRenewDeadline, "leader-election-renew-deadline", controller.DefaultLeaderElectionRenewDeadline, "The interval between attempts by the acting main to renew a leadership slot before it stops leading. This must be less than or equal to the lease duration. This is only applicable if leader election is enabled.")
