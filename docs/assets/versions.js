...
window.addEventListener("DOMContentLoaded", function() {
  ...
  if (currentVersion && currentVersion.length > 1) {
    ...
    if (currentVersion === "latest") {
      document.querySelector("div[data-md-component=announce]").innerHTML = "<div id='announce-msg'>You are viewing the docs for an unreleased version of Argo Rollouts, <a href='https://github.com/nholuongut/argo-rollouts/'>click here to go to the latest stable version.</a></div>";
      ...
      document.querySelector("div[data-md-component=announce]").innerHTML = "<div id='announce-msg'>You are viewing the docs for a previous version of Argo Rollouts, <a href='https://github.com/nholuongut/argo-rollouts/'>click here to go to the latest stable version.</a></div>";
      var bannerHeight = document.getElementById('announce-msg').offsetHeight + margin;
      document.querySelector("header.md-header").style.top = bannerHeight + "px";
      document.querySelector('style').textContent +=
          "@media screen and (min-width: 76.25em){ .md-sidebar { height: 0;  top:" + (bannerHeight + headerHeight) + "px !important; }}";
