...
started quickly, you can use pre-configured notification templates defined in [notifications-install.yaml](https://github.com/nholuongut/argo-rollouts/blob/main/manifests/notifications-install.yaml).

If you are leveraging Kustomize it is recommended to include [notifications-install.yaml](https://github.com/nholuongut/argo-rollouts/blob/main/manifests/notifications-install.yaml) as a remote
...
resources:
- https://github.com/nholuongut/argo-rollouts/releases/latest/download/install.yaml
- https://github.com/nholuongut/argo-rollouts/releases/latest/download/notifications-install.yaml
```
...
Currently the following triggers have [built-in templates](https://github.com/nholuongut/argo-rollouts/tree/main/manifests/notifications).
...
The condition language syntax is described at [Language-Definition.md](https://github.com/antonmedv/expr/blob/main/docs/Language-Definition.md).
