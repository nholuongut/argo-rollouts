...
This tutorial will walk you through the process of configuring Argo Rollouts to work with Ambassador to facilitate canary releases. All files used in this guide are available in the [examples](https://github.com/nholuongut/argo-rollouts/blob/main/examples/ambassador) directory of this repository.
