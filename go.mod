module github.com/nholuongut/argo-rollouts
...
require (
	...
	github.com/mainminds/goutils v1.1.1 // indirect
	github.com/mainminds/semver/v3 v3.2.0 // indirect
	github.com/mainminds/sprig/v3 v3.2.3 // indirect
