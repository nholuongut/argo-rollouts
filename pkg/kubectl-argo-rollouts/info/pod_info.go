...
func podIcon(status string) string {
	...
	// See:
	// https://github.com/kubernetes/kubernetes/blob/main/pkg/kubelet/images/types.go
	// https://github.com/kubernetes/kubernetes/blob/main/pkg/kubelet/kuberuntime/kuberuntime_container.go
	// https://github.com/kubernetes/kubernetes/blob/main/pkg/kubelet/container/sync_result.go
