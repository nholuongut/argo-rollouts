...
import (
	...
	"github.com/nholuongut/argo-rollouts/utils/annotations"

	"github.com/nholuongut/argo-rollouts/utils/diff"
	"k8s.io/apimachinery/pkg/runtime/schema"

	"github.com/nholuongut/argo-rollouts/pkg/apis/rollouts"
	...
	"github.com/nholuongut/argo-rollouts/controller/metrics"
	register "github.com/nholuongut/argo-rollouts/pkg/apis/rollouts"
	"github.com/nholuongut/argo-rollouts/pkg/apis/rollouts/v1alpha1"
	"github.com/nholuongut/argo-rollouts/pkg/apis/rollouts/validation"
	clientset "github.com/nholuongut/argo-rollouts/pkg/client/clientset/versioned"
	informers "github.com/nholuongut/argo-rollouts/pkg/client/informers/externalversions/rollouts/v1alpha1"
	listers "github.com/nholuongut/argo-rollouts/pkg/client/listers/rollouts/v1alpha1"
	"github.com/nholuongut/argo-rollouts/rollout/steps/plugin"
	"github.com/nholuongut/argo-rollouts/rollout/trafficrouting"
	"github.com/nholuongut/argo-rollouts/rollout/trafficrouting/ambassador"
	"github.com/nholuongut/argo-rollouts/rollout/trafficrouting/appmesh"
	"github.com/nholuongut/argo-rollouts/rollout/trafficrouting/istio"
	analysisutil "github.com/nholuongut/argo-rollouts/utils/analysis"
	"github.com/nholuongut/argo-rollouts/utils/conditions"
	controllerutil "github.com/nholuongut/argo-rollouts/utils/controller"
	"github.com/nholuongut/argo-rollouts/utils/defaults"
	experimentutil "github.com/nholuongut/argo-rollouts/utils/experiment"
	ingressutil "github.com/nholuongut/argo-rollouts/utils/ingress"
	istioutil "github.com/nholuongut/argo-rollouts/utils/istio"
	logutil "github.com/nholuongut/argo-rollouts/utils/log"
	"github.com/nholuongut/argo-rollouts/utils/record"
	replicasetutil "github.com/nholuongut/argo-rollouts/utils/replicaset"
	rolloututil "github.com/nholuongut/argo-rollouts/utils/rollout"
	serviceutil "github.com/nholuongut/argo-rollouts/utils/service"
	timeutil "github.com/nholuongut/argo-rollouts/utils/time"
	unstructuredutil "github.com/nholuongut/argo-rollouts/utils/unstructured"
)
...
func (c *Controller) syncHandler(ctx context.Context, key string) error {
	...
	// the rollout to have the replicas field set to the default value. see https://github.com/nholuongut/argo-rollouts/issues/119
	...
	if err != nil {
		...
		// https://github.com/nholuongut/argo-rollouts/issues/2522#issuecomment-1492181154 I also believe there are other cases
