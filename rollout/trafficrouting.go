...
import (
	...
	"github.com/nholuongut/argo-rollouts/rollout/trafficrouting/plugin"

	"github.com/nholuongut/argo-rollouts/pkg/apis/rollouts/v1alpha1"
	"github.com/nholuongut/argo-rollouts/rollout/trafficrouting"
	"github.com/nholuongut/argo-rollouts/rollout/trafficrouting/alb"
	"github.com/nholuongut/argo-rollouts/rollout/trafficrouting/ambassador"
	a6 "github.com/nholuongut/argo-rollouts/rollout/trafficrouting/apisix"
	...
	"github.com/nholuongut/argo-rollouts/rollout/trafficrouting/nginx"
	"github.com/nholuongut/argo-rollouts/rollout/trafficrouting/smi"
	"github.com/nholuongut/argo-rollouts/rollout/trafficrouting/traefik"
	a6util "github.com/nholuongut/argo-rollouts/utils/apisix"
	...
	"github.com/nholuongut/argo-rollouts/utils/weightutil"
)
...
func (c *rolloutContext) reconcileTrafficRouting() error {
	...
	for _, reconciler := range reconcilers {
		...
		if dynamicallyRollingBackToStable, prevDesiredHash := isDynamicallyRollingBackToStable(c.rollout, c.newRS); dynamicallyRollingBackToStable {
			...
			// See: https://github.com/nholuongut/argo-rollouts/issues/3020
