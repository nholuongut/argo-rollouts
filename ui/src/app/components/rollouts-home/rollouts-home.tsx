    ...
    return (
        <div className='rollouts-list__empty-message'>
            ...
            <div>
                ...
                <CodeLine>kubectl apply -f https://raw.githubusercontent.com/nholuongut/argo-rollouts/main/docs/getting-started/basic/rollout.yaml</CodeLine>
                <CodeLine>kubectl apply -f https://raw.githubusercontent.com/nholuongut/argo-rollouts/main/docs/getting-started/basic/service.yaml</CodeLine>
                or follow the{' '}
